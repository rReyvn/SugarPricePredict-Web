    ...
    function fetchAndRenderResults() {
        ...
        fetch(url)
            ...
            .then(data => {
                    ...
                    <div class="p-6 bg-white rounded-2xl shadow-md">
                        <div class="flex flex-wrap justify-between items-center mb-4 gap-4">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="w-48">
                                    <label for="province-select" class="block text-sm font-medium text-gray-700 sr-only">Province</label>
                                    <select id="province-select" name="province" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                provinceSelect.value = data.selected_province || currentProvince;
